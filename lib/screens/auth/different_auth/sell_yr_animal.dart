...
// ======================to get the location of the seller from device ===========================
  ...
  final _animalList = ['Buffalo', 'sheep', 'cow', 'goat', 'other'];
...
//==========================navigation=========================================
//
// if (_selectedVal == 'Buffalo') {
// Navigator.push(
// context,
// MaterialPageRoute(
// builder: (context) =>
// const BuffaloCategoryScreen(animalType: 'Buffalo'),
// ),
// );
// } else if (_selectedVal == 'sheep') {
// Navigator.push(
// context,
// MaterialPageRoute(
// builder: (context) =>
// const SheepCategoryScreen(animalType: 'Sheep'),
// ),
// );
// } else if (_selectedVal == 'cow') {
// Navigator.push(
// context,
// MaterialPageRoute(
...
// ),
// );
// } else if (_selectedVal == 'goat') {
// Navigator.push(
// context,
// MaterialPageRoute(
// builder: (context) => const GoatCategoryScreen(animalType: 'Goat'),
// ),
// );
// } else if (_selectedVal == 'other') {
// Navigator.push(
// context,
// MaterialPageRoute(
// builder: (context) =>
// const OthersCategoryScreen(animalType: 'Other'),
// ),
// );
// }
